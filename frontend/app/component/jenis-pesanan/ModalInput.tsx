...
export default function ModalInput({ openModal, setOpenModal, onSaveHandler }: props) {
    ...
    <Modal show={openModal} size="md" popup onClose={() => setOpenModal(false)} initialFocus={nameInputRef}>
      ...
      <Modal.Body>
        <div className="space-y-6">
          <h3 className="text-xl font-medium text-gray-900 dark:text-white">Jenis Pesanan</h3>
          <div>
